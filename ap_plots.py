...
c.cd(1)
gPad.SetLogy(1)
events2.Draw("triEndZ>>prodZ(50,0,100)","triP>0.8*1.056","colz,goff")
...
c.cd(1)
#gPad.SetLogy(1)
events.Draw("triEndZ>>hnew(50,0,100)","triP>0.8*1.056&&bscP>0.8*1.056","colz,goff")
hnew = gDirectory.Get("hnew")
hnew.Draw()
c.cd(2)
eff=hnew.Clone("eff")
...
c.cd(1)
#gPad.SetLogy(1)
events.Draw("triEndZ>>hnew(50,0,100)","triP>0.8*1.056&&bscP>0.8*1.056&&eleHasL1&&posHasL1","colz,goff")
hnew = gDirectory.Get("hnew")
hnew.Draw()
c.cd(2)
eff=hnew.Clone("eff")
...
c.cd(1)
gPad.SetLogz(1)
events.Draw("uncVZ-triEndZ:triEndZ>>hnew(50,0,100,50,-20,20)","triP>0.8*1.056&&bscP>0.8*1.056","colz")
hnew = gDirectory.Get("hnew")
hnew.FitSlicesY()
hnew_1 = gDirectory.Get("hnew_2")
c.cd(2)
hnew_1.Draw()
hnew_1.Fit("pol2","","",0,100)
...
c.cd(1)
gPad.SetLogz(1)
events.Draw("uncVZ-triEndZ:triEndZ>>hnew(50,0,100,50,-20,20)","triP>0.8*1.056&&bscP>0.8*1.056&&eleHasL1&&posHasL1","colz")
hnew = gDirectory.Get("hnew")
hnew.FitSlicesY()
hnew_1 = gDirectory.Get("hnew_2")
c.cd(2)
...
c.cd(1)
gPad.SetLogz(1)
events.Draw("uncM-triM:triEndZ>>hnew(50,0,100,50,-0.02,0.02)","triP>0.8*1.056&&bscP>0.8*1.056","colz")
hnew = gDirectory.Get("hnew")
hnew.FitSlicesY()
hnew_1 = gDirectory.Get("hnew_2")
c.cd(2)
...
c.cd(1)
gPad.SetLogz(1)
events.Draw("uncM-triM:triEndZ>>hnew(50,0,100,50,-0.02,0.02)","triP>0.8*1.056&&bscP>0.8*1.056&&eleHasL1&&posHasL1","colz")
hnew = gDirectory.Get("hnew")
hnew.FitSlicesY()
hnew_1 = gDirectory.Get("hnew_2")
c.cd(2)
