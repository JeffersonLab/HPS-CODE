...
plots.append("uncPX -{0} {0}".format(0.04*energy))
plots.append("uncPY -{0} {0}".format(0.04*energy))
...
plots.append("elePX -{0} {0}".format(0.04*energy))
plots.append("posPX -{0} {0}".format(0.04*energy))
plots.append("elePY -{0} {0}".format(0.04*energy))
plots.append("posPY -{0} {0}".format(0.04*energy))
...
if(not quickPlots):
	...
	plots.append("eleTrkOmega -0.001 0.001")
	plots.append("posTrkOmega -0.001 0.001")
	plots.append("eleTrkPhi -0.5 0.5")
	plots.append("posTrkPhi -0.5 0.5")
	...
	plots.append("nSVTHitsL1 0 1000")
	plots.append("nSVTHitsL1b 0 1000")
...
plots2D = []
plots2D.append("uncM uncVZ {2} {0} {1}".format(minVZ,maxVZ,0.1*energy))
plots2D.append("eleTrkEcalX eleTrkEcalY -300 300 -100 100")
plots2D.append("posTrkEcalX posTrkEcalY -300 300 -100 100")

if(not quickPlots):
	plots2D.append("posMatchChisq eleMatchChisq 0 10 0 10")
	plots2D.append("eleTrkEcalX eleTrkEcalY -300 300 -100 100")
	plots2D.append("posTrkEcalX posTrkEcalY -300 300 -100 100")
