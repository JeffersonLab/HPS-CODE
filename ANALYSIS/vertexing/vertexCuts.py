...
trkExtrpCutL1L2 = "((!eleHasL1&&posHasL1&&(eleTrkExtrpYSensorAxialTopL1>-19.2||eleTrkExtrpYSensorAxialBotL1>-19.2)&&(eleTrkExtrpYSensorStereoTopL1<19.2&&eleTrkExtrpYSensorStereoTopL1>-19.2)||(eleTrkExtrpYSensorStereoBotL1<19.2&&eleTrkExtrpYSensorStereoBotL1>-19.2))||(eleHasL1&&!posHasL1&&(posTrkExtrpYSensorAxialTopL1>-19.2||posTrkExtrpYSensorAxialBotL1>-19.2)&&(posTrkExtrpYSensorStereoTopL1<19.2&&posTrkExtrpYSensorStereoTopL1>-19.2)||(posTrkExtrpYSensorStereoBotL1<19.2&&posTrkExtrpYSensorStereoBotL1>-19.2)))"

trkExtrpCutL2L2 = "(((eleTrkExtrpYSensorAxialTopL1>-19.2||eleTrkExtrpYSensorAxialBotL1>-19.2)&&(posTrkExtrpYSensorAxialTopL1>-19.2||posTrkExtrpYSensorAxialBotL1>-19.2))&&((eleTrkExtrpYSensorStereoTopL1<19.2&&eleTrkExtrpYSensorStereoTopL1>-19.2)||(eleTrkExtrpYSensorStereoBotL1<19.2&&eleTrkExtrpYSensorStereoBotL1>-19.2))&&((posTrkExtrpYSensorStereoTopL1<19.2&&posTrkExtrpYSensorStereoTopL1>-19.2)||(posTrkExtrpYSensorStereoBotL1<19.2&&posTrkExtrpYSensorStereoBotL1>-19.2)))"
...
vertCutL1L2 = "((!eleHasL1&&posHasL1&&min(eleMinPositiveIsoL2+0.33*(eleTrkZ0+{2}*elePY/eleP)*sign(elePY),posMinPositiveIso+0.5*(posTrkZ0+{2}*posPY/posP)*sign(posPY))>0)||(eleHasL1&&!posHasL1&&min(eleMinPositiveIso+0.5*(eleTrkZ0+{2}*elePY/eleP)*sign(elePY),posMinPositiveIsoL2+0.33*(posTrkZ0+{2}*posPY/posP)*sign(posPY))>0))&&isPair1&&max(eleMatchChisq,posMatchChisq)<10&&max(abs(eleClT-eleTrkT-{1}),abs(posClT-posTrkT-{1}))<4&&abs(eleClT-posClT)<2&&eleClY*posClY<0&&bscChisq<10&&bscChisq-uncChisq<5&&max(eleTrkChisq,posTrkChisq)<30&&abs(eleP-posP)/(eleP+posP)<0.5&&posTrkD0+{2}*posPX/posP<1.5&&eleP<{0}*0.75&&uncP<{0}*1.15&&uncP>0.8&&eleHasL2&&posHasL2&&((!eleHasL1&&posHasL1&&(eleTrkExtrpYSensorAxialTopL1>-19.2||eleTrkExtrpYSensorAxialBotL1>-19.2)&&(eleTrkExtrpYSensorStereoTopL1<19.2&&eleTrkExtrpYSensorStereoTopL1>-19.2)||(eleTrkExtrpYSensorStereoBotL1<19.2&&eleTrkExtrpYSensorStereoBotL1>-19.2))||(eleHasL1&&!posHasL1&&(posTrkExtrpYSensorAxialTopL1>-19.2||posTrkExtrpYSensorAxialBotL1>-19.2)&&(posTrkExtrpYSensorStereoTopL1<19.2&&posTrkExtrpYSensorStereoTopL1>-19.2)||(posTrkExtrpYSensorStereoBotL1<19.2&&posTrkExtrpYSensorStereoBotL1>-19.2)))"

vertCutL2L2 = "!eleHasL1&&!posHasL1&&min(eleMinPositiveIsoL2+0.33*(eleTrkZ0+{2}*elePY/eleP)*sign(elePY),posMinPositiveIsoL2+0.33*(posTrkZ0+{2}*posPY/posP)*sign(posPY))>0&&isPair1&&max(eleMatchChisq,posMatchChisq)<10&&max(abs(eleClT-eleTrkT-{1}),abs(posClT-posTrkT-{1}))<4&&abs(eleClT-posClT)<2&&eleClY*posClY<0&&bscChisq<10&&bscChisq-uncChisq<5&&max(eleTrkChisq,posTrkChisq)<30&&abs(eleP-posP)/(eleP+posP)<0.5&&posTrkD0+{2}*posPX/posP<1.5&&eleP<{0}*0.75&&uncP<{0}*1.15&&uncP>0.8&&eleHasL2&&posHasL2&&(((eleTrkExtrpYSensorAxialTopL1>-19.2||eleTrkExtrpYSensorAxialBotL1>-19.2)&&(posTrkExtrpYSensorAxialTopL1>-19.2||posTrkExtrpYSensorAxialBotL1>-19.2))&&((eleTrkExtrpYSensorStereoTopL1<19.2&&eleTrkExtrpYSensorStereoTopL1>-19.2)||(eleTrkExtrpYSensorStereoBotL1<19.2&&eleTrkExtrpYSensorStereoBotL1>-19.2))&&((posTrkExtrpYSensorStereoTopL1<19.2&&posTrkExtrpYSensorStereoTopL1>-19.2)||(posTrkExtrpYSensorStereoBotL1<19.2&&posTrkExtrpYSensorStereoBotL1>-19.2)))"

options, remainder = getopt.gnu_getopt(sys.argv[1:], 'vwxyabe:c:z:h')
