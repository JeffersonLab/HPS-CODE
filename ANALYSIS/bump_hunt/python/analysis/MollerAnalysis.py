...
class MollerAnalysis(object):
    ...
    def has_clusters_e_side(self, particle):
        ...
        for index in xrange(0, 2): 
            if particle.getClusters().At(index).getPosition()[0] >= 0: return False
    ...
    def process(self, event): 
        ...
        for particle_n in xrange(0, v0_count): 
            ...
            # Require the two v0 tracks to be on the electron side.
            self.ntuple['has_clusters_e_side'].append(self.has_clusters_e_side(particle))
