...
analysis_postfix='pass4_useGBL_ECalMatch_L6Ele'
...
#            dstfile=data_dir+"/"+data_prefix+run+"."+pref+"[0-9]_"
            ...
            outdir='OutputHistograms/Data/'+analysis_postfix+'/'
            if not os.path.exists(outdir):
                os.makedirs(outdir)
            outfile=outdir+anapre+data_prefix+run+"."+str(jobcnt)+'_'+analysis_postfix+'.root'
