...
if doMC is True : 
    for mcType in mcTypeList:
        logfile='logs/debugme'+anapre+mcType+'_'+mc_prefix+'_'+analysis_postfix+'.log'
        os.system('rm '+logfile)
        outfile='OutputHistograms/MC/foobar'+mcType+'_'+mc_prefix+'_'+analysis_postfix+'.root'
