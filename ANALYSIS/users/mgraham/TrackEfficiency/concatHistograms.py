...
runno="8099"
label="pass4_useGBL_ECalMatch"
instring="OutputHistograms/Data/hpsrun2016_pass4_useGBL_ECalMatch/fromscratch_hps_00"+runno+".*"+label+".root"
outputname="OutputHistograms/Data/hps_00"+runno+"_"+label+".root"
