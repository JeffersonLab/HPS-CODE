...
jarfile="./hps-distribution-4.4-SNAPSHOT-bin.jar"
...
#    label="svt-efficiency-cluster-killing-5-sigma-L1-L6"
#    jarfile="./hps-distribution-4.4-svt-hit-killer-5-sigma-bin.jar"
#    steering="/nfs/slac/g/hps/HPS-CODE/ANALYSIS/users/mgraham/SVTHitEfficiency/SVTHitPlotsWithSVTClusterKilling.lcsim"

#    label="svt-efficiency-cluster-killing-5-sigma-L1t-axial"
#    jarfile="./hps-distribution-4.4-svt-hit-killer-5-sigma-bin.jar"
#    steering="/nfs/slac/g/hps/HPS-CODE/ANALYSIS/users/mgraham/SVTHitEfficiency/SVTHitPlotsWithSVTClusterKillingL1tAxial.lcsim"
    label="svt-efficiency-cluster-killing-weighted-ratios-L6-0pt05mm"
    jarfile="./hps-distribution-4.4-svt-hit-killer-weighted-ratios-L6-0pt05mm.jar"
    steering="/nfs/slac/g/hps/HPS-CODE/ANALYSIS/users/mgraham/SVTHitEfficiency/SVTHitPlotsWithSVTClusterKilling.lcsim"
 #    label="svt-efficiency-no-killing"
#    steering="/nfs/slac/g/hps/HPS-CODE/ANALYSIS/users/mgraham/SVTHitEfficiency/SVTHitPlots.lcsim"

#    mcTypeList=['wabtrig-BT','WBT']
    ...
    for mcType in mcTypeList:
        ...
        while incnt<len(foobar): 
            ...
            os.system("rm "+logfile)
            outfile=outDataDir+mcType+'_'+mc_prefix+"-"+label+str(jobcnt)
#        print(outfile)
