...
#    addMCHistos=True #this only makes sense right now if we only have MC samples that should add..i.e. not "wab-beam-tri"
     iLumi=20.55*1000.0 # ub^-1  run 8028 10% from spreadsheet
...
#wab-beam-tri Luminosity
     wabBeamTriMG5Lumi=.344*971 #ub^-1
...
#     plotFilePostFix="_ScaleWABBy0pt87_NoRatios"
     ...
     mcLabel="_HPS-PhysicsRun2016-v5-3"+mcpass+label
     prefix="fromscratch_"
     run="hps_008028"
     dataNorm=[1/iLumi]
...
#          mcFile.append(ROOT.TFile(mcPath+prefix+sample+mcLabel+label+".root"))
     ...
     plotFileName="SummaryPlots2016/allplots"+datalabel+mcTag+plotFilePostFix+".pdf"
