...
def main():
    ...
    from ROOT import HpsEvent, SvtTrack, EcalCluster, EcalHit, TChain, TTree
...
#        print "passed trigger cuts"
        nEvents+=1
        n_tracks=hps_event.getNumberOfTracks()
#        print n_tracks
...
#        print "passed basic cuts"
        ...
        for uc_index in xrange(0, hps_event.getNumberOfParticles(hps_event.UC_VTX_PARTICLES)):
            particle = hps_event.getParticle(hps_event.UC_VTX_PARTICLES, uc_index)
...
#            print "Passed track cuts"
        ...
        for index in range(0,len(candidateList)) :
            particle = hps_event.getParticle(hps_event.UC_VTX_PARTICLES, candidateList[index])
            vchi2=particle.getVertexFitChi2();
            vposition=particle.getVertexPosition();
            vmomentum=particle.getMomentum();
