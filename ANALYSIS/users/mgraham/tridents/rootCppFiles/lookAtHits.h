...
// Thu Aug 13 17:28:17 2015 by ROOT version 5.34/26
// from TTree HPS_Event/HPS event tree
// found on file: pass1-dst/hps_005772.40_dst_R3321.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxtracks = 22;
   const Int_t kMaxsvt_hits = 300;
   const Int_t kMaxecal_clusters = 13;
   const Int_t kMaxecal_hits = 50;
   const Int_t kMaxfs_particles = 25;
   const Int_t kMaxuc_vtx_particles = 72;
   const Int_t kMaxbsc_vtx_particles = 72;
   const Int_t kMaxtc_vtx_particles = 72;
...
#ifdef lookAtHits_cxx
lookAtHits::lookAtHits(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("pass1-dst/hps_005772.40_dst_R3321.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("pass1-dst/hps_005772.40_dst_R3321.root");
      }
...
lookAtHits::~lookAtHits()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t lookAtHits::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t lookAtHits::LoadTree(Long64_t entry)
{
...
void lookAtHits::Init(TTree *tree)
{
...
void lookAtHits::Show(Long64_t entry)
{
...
Int_t lookAtHits::Cut(Long64_t entry)
{
