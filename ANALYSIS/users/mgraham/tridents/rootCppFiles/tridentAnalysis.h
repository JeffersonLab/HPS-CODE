...
// Tue Aug  4 12:42:56 2015 by ROOT version 5.34/26
// from TTree HPS_Event/HPS event tree
// found on file: ../EngRun2015/pass1/dst/hps_005772.0_dst_R3321.root
//////////////////////////////////////////////////////////

#ifndef tridentAnalysis_h
#define tridentAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxtracks = 26;
   const Int_t kMaxsvt_hits = 136;
   const Int_t kMaxecal_clusters = 12;
   const Int_t kMaxecal_hits = 47;
   const Int_t kMaxfs_particles = 29;
   const Int_t kMaxuc_vtx_particles = 105;
   const Int_t kMaxbsc_vtx_particles = 105;
   const Int_t kMaxtc_vtx_particles = 105;
...
public :
 ...
 //HpsEvent        *Event;
   ...
   tridentAnalysis(TTree *tree=0);
   virtual ~tridentAnalysis();
...
#ifdef tridentAnalysis_cxx
tridentAnalysis::tridentAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../EngRun2015/pass1/dst/hps_005772.0_dst_R3321.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../EngRun2015/pass1/dst/hps_005772.0_dst_R3321.root");
      }
...
Int_t tridentAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tridentAnalysis::LoadTree(Long64_t entry)
{
...
void tridentAnalysis::Init(TTree *tree)
{
...
void tridentAnalysis::Show(Long64_t entry)
{
...
Int_t tridentAnalysis::Cut(Long64_t entry)
{
...
double tridentAnalysis::getMomentum(int fspart){  
  return TMath::Sqrt(fs_particles_px[fspart]*fs_particles_px[fspart]+fs_particles_py[fspart]*fs_particles_py[fspart]+fs_particles_pz[fspart]*fs_particles_pz[fspart]);
}

#endif // #ifdef tridentAnalysis_cxx
