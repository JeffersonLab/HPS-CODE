...
// basic sanity cuts
      ...
      if(n_uc_vtx_particles!=1)continue; //required only 2 tracks = 1 v0 in event so we can keep it simple...      
      ...
      tridentVx->Fill(uc_vtx_particles_vtx_x[uc_index]);
      tridentVy->Fill(uc_vtx_particles_vtx_y[uc_index]);
      tridentVz->Fill(uc_vtx_particles_vtx_z[uc_index]);
      tridentMassVtxCut->Fill(uc_vtx_particles_mass[uc_index]);
