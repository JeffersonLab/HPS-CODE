...
#    else:
#    cluDeltaT=2#ns
    cluDeltaT=3#ns  the deltaT is a bit wider for 2.3 GeV
#    cluDeltaT=10#ns
#    cluTrkDeltaT=4.5#ns
    cluTrkDeltaT=5.8#ns
    cluTrkOffset=43#ns
...
####  these two are wab supression
    requireWABD0Cut=False
    requireWABPtCut=False
####
    useGBL=True
#################
        ...
        if doEmGam: 
            for ele in eleList : 
                ...
                for gam in gamList: 
                    ...
                    if  requireECalTimingCoincidence and not myhist.simpleClusterCoincidence(ele,gam,cluDeltaT) :
                        continue
        ...
        if doEpGam: 
            for pos in posList : 
                ...
                for gam in gamList: 
                    v0=None
                    gamY=gam.getClusters().First().getPosition()[1]
                    if  requireECalTimingCoincidence and not myhist.simpleClusterCoincidence(pos,gam,cluDeltaT) :
                        continue
