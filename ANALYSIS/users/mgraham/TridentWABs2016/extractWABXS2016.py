...
#    addMCHistos=True #this only makes sense right now if we only have MC samples that should add..i.e. not "wab-beam-tri"
     iLumi=237*1000.0*281/284. # ub^-1  run 8099 from spreadsheet
#wabv3AF_200MeV_5mrad
#     wabXS=181.7*1000.0 #ub...this is the lower peak 
     wabXS=220*1000.0 #ub...this is the higher peak 
#     wabNGen=10000*9491# this one is for all pass4 dst at slac  
     wabNGen=10000*5296.#  this one is for recon->dst at slac, e.g. cluster killing
#tritrig with ESum>0.5 GeV and 5mrad
     tritrigMG5XS= 1.1416*1000.0 #ub
     tritrigMG5NGen=10000.0*928#  
...
#  I think I prefer to use 100010 events/readout file * 50 readout files
     radMG5XS = 0.0667*1000.0#ub
     radMG5NGen = 10000*100
############
#wab-beam-tri Luminosity
     wabBeamTriMG5Lumi=.344*902 #ub^-1
...
#     label="NoESumCut_OmarsBase_WABCuts"
     label="NoESumCut_OmarsBase_ClusterDeltaT"
...
#     plotFilePostFix="_ScaleWABBy0pt87_NoRatios"
     ...
     mcLabel="_HPS-PhysicsRun2016-Pass2"+mcpass+label+"_ClusterKilling_WeightedRatios_L6_0pt1mm"
#     mcLabel="_HPS-PhysicsRun2016-Pass2"+mcpass+label
     plotFilePostFix="_ClusterKilling_WeightedRatios_L6_0pt1mm_ScaleAllBy0pt91"
#     plotFilePostFix="_ClusterKilling_WeightedRatios_L6_0pt1mm"
#     plotFilePostFix=""
     prefix="fromscratch_"
     run="hps_008099"
     dataNorm=[1/iLumi]
...
#     mcSamples=["wab-beam","tritrig-beam","RAD-beam","wab-beam-tri"]
     mcSamples=["wabtrig-BT","tritrig-WB","RADtrig-WBT","WBT"]
     mcNorm=[wabXS/wabNGen,tritrigMG5XS/tritrigMG5NGen,radMG5XS/radMG5NGen,1/wabBeamTriMG5Lumi]
     mcLegends=["WAB+beam","TriTrig+beam","Rad+beam", "Wab-Beam-Tri"]

#     mcScale=[1.0, 1.0, 1.0, 1.0]
     mcScale=[0.91, 0.91, 1.0, 1.0]
