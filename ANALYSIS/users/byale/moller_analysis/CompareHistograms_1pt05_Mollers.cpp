...
const double num_files = 862*10; // wab-beam-tri files (singles0)
...
double MC_Lumin = 74*(5e5)*(625)*(4.062e-4)*(6.306e-2)*num_files; // "" for wab-beam-tri (500k bunches)
...
// Pairs1
//tr1->Add("/cache/mss/hallb/hps/production/postTriSummitFixes/dst/wab-beam-tri/1pt05/wabv2-egsv5-triv2-g4v1_zipFix_10to1_HPS-EngRun2015-Nominal-v5-0-fieldmap_3.10-20160813_pairs1_*.root");
...
//  GblTrack *moller_track1, *moller_track2;
  ...
  TH2D *moller_thetaE = new TH2D("Pass3 MollerCandidates","Moller Theta vs. Cluster E;Energy (GeV);Theta (rad)",200,0.0,2.5,200,0.0,0.13);
  TH1D *moller_E = new TH1D("moller Cluster E", ";Energy (GeV)", 200, 0., 2.5);
  TH2D *moller_thetaTrackE = new TH2D("Pass3 MollerCandidates","Moller Theta vs. Track E;Energy (GeV);Theta (rad)",200,0.0,2.5,200,0.0,0.13);
  TH1D *moller_TrackE = new TH1D("moller TrackE", ";Energy (GeV)", 200, 0., 2.5);

  TH1D *moller_Theta = new TH1D("moller_Theta", ";Theta (rad)", 200, 0.015, 0.13);
 
  TH1D *moller_ESum = new TH1D("moller_E1+E2","Energy Sum;Energy (GeV)", 200, 0., 1.3);
  TH2D *unrot_moller_thetaE = new TH2D("Pass3 MollerCandidates","'Unrotated' Moller Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2.5,200,0.0,0.13);
  ...
  TH2D *MollerTT = new TH2D("Pass3 MollerCandidates","Theta1 vs. Theta2;Theta (rad);Theta (rad)",200,0.0,0.13,200,0.0,0.13);
...
// CUT Moller Tests ("V0" = "Mollers", haven't renamed everything...)
  TH2D *CUT_moller_thetaE = new TH2D("CUT_moller_thetaE","Moller Theta vs. Track E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);
  TH1D *TRACK_V0_E = new TH1D("Moller_Track_E","Track E;Energy (GeV)",200,0,1);
  TH1D *EDGE_TRACK_V0_E = new TH1D("EDGE_TRACK_Moller_E","Track E (Edge);Energy (GeV)", 200, 0., 2);
  TH1D *FIDUCIAL_TRACK_V0_E = new TH1D("FIDUCIAL_TRACK_Moller_E","Track E (Fiducial);Energy (GeV)", 200, 0., 2);
  TH1D *TRACK_V0_E1 = new TH1D("TRACK_Moller_E1","Top Track E1;Energy (GeV)", 200, 0., 2);
  TH1D *TRACK_V0_E2 = new TH1D("TRACK_Moller_E2","Bottom Track E2;Energy (GeV)", 200, 0., 2);

// ALL EVENT TRACKS
  TH1D *eventsTrackE = new TH1D("eventsTrackE","Track E;Energy (GeV)", 180, 0, 1.2);
  TH1D *DATA_eventsTrackE = new TH1D("DATA_eventsTrackE","Track E;Energy (GeV)", 180, 0, 1.2);
  TH1D *PURE_eventsTrackE = new TH1D("PURE_eventsTrackE","Track E;Energy (GeV)", 180, 0, 1.2);

  TH1D *CLUSTER_V0_E = new TH1D("CLUSTER_Moller_E","Cluster E;Energy (GeV)", 200, 0., 1);
  TH1D *CLUSTER_V0_E1 = new TH1D("CLUSTER_Moller_E1","Top Cluster E;Energy (GeV)", 200, 0., 1);
  TH1D *CLUSTER_V0_E2 = new TH1D("CLUSTER_Moller_E2","Bottom Cluster E;Energy (GeV)", 200, 0., 1);

  TH1D *FIDUCIAL_V0_E = new TH1D("FIDUCIAL_Moller_E","Cluster E (Fiducial);Energy (GeV)", 200, 0., 1);
  TH1D *EDGE_V0_E = new TH1D("EDGE_Moller_E","Cluster E (Edge);Energy (GeV)", 200, 0., 1);


  TH1D *CUT_V0_Theta = new TH1D("CUT_Moller_Theta", ";Unrot Theta (rad)", 200, 0.0, 0.08);

  TH1D *TRACK_V0_ESum = new TH1D("Track_Moller_ESum","Track Energy Sum;Energy (GeV)", 200, 0, 2);
  TH1D *CLUSTER_V0_ESum = new TH1D("CLUSTER_Moller_ESum","Cluster Energy Sum;Energy (GeV)", 200, 0., 2);
  TH1D *TRACK_V0_EDiff = new TH1D("TRACK_Moller_EDiff","Track Energy Difference;Energy (GeV)", 200, 0., 2);
  TH1D *CLUSTER_V0_EDiff = new TH1D("CLUSTER_Moller_EDiff","Cluster Energy Difference;Energy (GeV)", 200, 0., 2);


  TH1D *FIDUCIAL_V0_ESum = new TH1D("FIDUCIAL_Moller_ESum","Cluster Energy Sum (Fiducial);Energy (GeV)", 200, 0., 2);
  TH1D *EDGE_V0_ESum = new TH1D("EDGE_Moller_ESum","Cluster Energy Sum (Edge);Energy (GeV)", 200, 0., 2);

  TH2D *CUT_unrot_V0_thetaE = new TH2D("CUT_unrot_Moller_thetaE","'Unrotated' Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);

  TH2D *CUT_ESumE = new TH2D("CUT_ESumE","Track ESum vs. Energy;GeV;GeV",200,0.0,3,200,0.0,2);
  TH2D *DATA_ESumE = new TH2D("DATA_ESumE","Track ESum vs. Energy;GeV;GeV",200,0.0,3,200,0.0,2);
  TH2D *PURE_ESumE = new TH2D("PURE_ESumE","Track ESum vs. Energy;GeV;GeV",200,0.0,3,200,0.0,2);

  TH2D *CUT_ESumE1 = new TH2D("CUT_ESumE1","Track ESum vs. Energy;GeV;GeV",200,0.0,3,200,0.0,2);
  TH2D *CUT_ESumE2 = new TH2D("CUT_ESumE2","Track ESum vs. Energy;GeV;GeV",200,0.0,3,200,0.0,2);
  ...
  TH2D *CUT_V0TT = new TH2D("CUT_MollerTT","Theta1 vs. Theta2;Theta (rad);Theta (rad)",200,0.0,0.13,200,0.0,0.13);
  TH1D *CUT_SinSinTest = new TH1D("CUT_SinSinTest","Prox. to Model (m/2Ebeam);Sin(T1/2)Sin(T2/2)", 200, 0,0.0008);
  TH2D *CUT_V0_EP = new TH2D("CUT_moller_EP","Momentum vs. Cluster Energy;Energy (GeV);Momentum (GeV/c)",200,0.0,1.056,200,0.0,1.056);
...
// Track parameter-related
  ...
  // MASS
  TH1D *V0_Mass = new TH1D("Moller_Mass","Uncut Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *CUT_V0_Mass = new TH1D("CUT_Moller_Mass","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *massSingles1 = new TH1D("massSingles1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *massGBL = new TH1D("massGBL","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *mass1 = new TH1D("mass1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *mass2 = new TH1D("mass2","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *mass3 = new TH1D("mass3","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *mass4 = new TH1D("mass4","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *massMatch = new TH1D("massMatch","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_massSingles1 = new TH1D("DATA_massSingles1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_massGBL = new TH1D("DATA_massGBL","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_mass1 = new TH1D("DATA_mass1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_mass2 = new TH1D("DATA_mass2","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_mass3 = new TH1D("DATA_mass3","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_mass4 = new TH1D("DATA_mass4","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *DATA_massMatch = new TH1D("DATA_massMatch","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_massSingles1 = new TH1D("PURE_massSingles1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_massGBL = new TH1D("PURE_massGBL","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_mass1 = new TH1D("PURE_mass1","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_mass2 = new TH1D("PURE_mass2","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_mass3 = new TH1D("PURE_mass3","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_mass4 = new TH1D("PURE_mass4","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);
  TH1D *PURE_massMatch = new TH1D("PURE_massMatch","Moller_Candidate Invariant Mass;Mass(GeV)", 200, 0.00,0.06);

  TH2D *ESumMass = new TH2D("ESumMass","ClustESum vs. Mass;GeV;ns",200,0.00,0.06,200,0,1.3);
  TH2D *DATA_ESumMass = new TH2D("DATA_ESumMass","ClustESum vs. Mass (data);GeV;ns",200,0.00,0.06,200,0,1.3);
  TH2D *PURE_ESumMass = new TH2D("PURE_ESumMass","ClustESum vs. Mass (pure);GeV;ns",200,0.00,0.06,200,0,1.3);
...
// FIRST MOLLER
        ...
        //  double phi01 = moller_track1->getPhi0();
          ...
          // Find Model energy
          double denom1 = 1+2*sin(unrot_theta1/2)*sin(unrot_theta1/2)*(1056/0.5109989);
          double model1 = 1.056/denom1;
...
// SECOND MOLLER
          ...
          // Find Model energy2
          double denom2 = 1+2*sin(unrot_theta2/2)*sin(unrot_theta2/2)*(1056/0.5109989);
          double model2 = 1.056/denom2;
...
//   if(ev1->isPulserTrigger())
	{
         ...
         //  moller_thetaE->Fill(E1,theta1); moller_thetaE->Fill(E2,theta2);
           ...
           unrot_moller_thetaE->Fill(TrackE1,unrot_theta1); unrot_moller_thetaE->Fill(TrackE2,unrot_theta2);
  ...
  //          if((phi01 <= 60 || phi01 >=120) && (phi02 <= 60 || phi02 >=120) && abs(phi01 - phi02) <= 20)
     ...
     //      if(unrot_theta1+unrot_theta2>=0.05)
           // if(TrackE1+TrackE2<=1.2 && TrackE1+TrackE2>=0.9 && E1+E2<=1.2 && E1+E2>=0.9)
            if(TrackE1+TrackE2<=1.2 && TrackE1+TrackE2>=0.9)
             {
...
//Momar Cuts //if(TrackE1>=0.05 && TrackE2>=0.05 && TrackE1<=0.85 && TrackE2<=0.85 && abs(time1-time2)<=1.6 && tanLambda1*tanLambda2 < 0)
         ...
         //       }
               ...
               hitxDiff->Fill(position1[0] - trackAtEcal1[0]); hitxDiff->Fill(position2[0] - trackAtEcal2[0]);          
...
//  const double DATA_time=10.48278; // time for 90 5772 files
 ...
 // double DATA_Lumin = (DATA_Ne)*rho*t*Na/A;
...
double DATA_Prescale = 8192; //eng2015 singles0, 2^13
...
tr2->Add("/cache/mss/hallb/hps/engrun2015/pass6/dst/hps_005772.*_dst_R3.8.root");

//tr2->Add("/u/group/hps/production/mc/EngRun2015Scripts/tritrig_standardRecon.root");
  ...
  TH2D *DATA_CUT_moller_thetaE = new TH2D("DATA_CUT_moller_thetaE","Moller Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);
  ...
  TH1D *DATA_TrackE = new TH1D("DATA_TrackE","Track Energy;Energy (GeV)", 200, 0.,1);
//  TH2D *DATA_ClusterEE = new TH2D("DATA_ClusterEE","Cluster E1 vs. E2;Electron E (GeV);Positron E (GeV)",200,0.0,2.5,200,0.0,2.5);
  TH2D *DATA_ClusterEE = new TH2D("DATA_ClusterEE","Cluster E1 vs. E2;E1 (GeV);E2 (GeV)",200,0.0,2,200,0.0,2);
  TH1D *DATA_CUT_moller_Theta = new TH1D("DATA_CUT_moller_Theta", ";Theta (rad)", 200, 0.0, 0.08);
  TH1D *DATA_TRACK_ESum = new TH1D("DATA_TRACK_ESum","V0 Track Energy Sum;Energy (GeV)", 200, 0,2);
  TH1D *DATA_CLUSTER_ESum = new TH1D("DATA_CLUSTER_ESum","V0 Cluster Energy Sum;Energy (GeV)", 200, 0.,2);
  TH2D *DATA_CUT_unrot_moller_thetaE = new TH2D("DATA_CUT_unrot_moller_thetaE","'Unrotated' Moller Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);
...
//  TH2D *DATA_TrackEE = new TH2D("DATA_TrackEE","Track E1 vs. E2;Electron E (GeV);Positron E (GeV)",200,0.0,1.056,200,0.0,1.056);
  ...
  TH2D *DATA_CUT_MollerTT = new TH2D("DATA_CUT_MollerTT","Theta1 vs. Theta2;Theta (rad);Theta (rad)",200,0.0,0.13,200,0.0,0.13);
  ...
  TH1D *DATA_Mass = new TH1D("DATA_Mass","V0 Candidate Mass;Mass(GeV)", 200, 0.00,0.06);
  ...
  TH1D *DATA_moller_ESum = new TH1D("DATA_moller_ESum","Track Energy Sum;Energy (GeV)", 200, 0.0, 2);
...
//     if(true)
	...
	// FIRST MOLLER
	  DATA_moller_clust1 = (EcalCluster*)DATA_moller_clusters1->At(0);
          ...
          // 'Unrotate' momentum1
          double DATA_unrot_px1 = DATA_px1*cos(-0.0295) + DATA_pz1*sin(-0.0295);
          double DATA_unrot_pz1 = DATA_pz1*cos(-0.0295) - DATA_px1*sin(-0.0295);
          double DATA_unrot_theta1 = atan2(sqrt(DATA_unrot_px1*DATA_unrot_px1 + DATA_py1*DATA_py1),DATA_unrot_pz1);
          // Find Model energy
          double DATA_denom1 = 1+2*sin(DATA_unrot_theta1/2)*sin(DATA_unrot_theta1/2)*(1056/0.5109989);
          double DATA_model1 = 1.056/DATA_denom1;
        ...
        // SECOND MOLLER
          ...
          vector<double>  DATA_mom2 = DATA_moller2->getMomentum(); double DATA_px2 = DATA_mom2[0]; double DATA_py2 = DATA_mom2[1]; double DATA_pz2 = DATA_mom2[2];
           ...
           // 'Unrotate' momentum2
           double DATA_unrot_px2 = DATA_px2*cos(-0.0295) + DATA_pz2*sin(-0.0295);
           double DATA_unrot_pz2 = DATA_pz2*cos(-0.0295) - DATA_px2*sin(-0.0295);
           double DATA_unrot_theta2 = atan2(sqrt(DATA_unrot_px2*DATA_unrot_px2 + DATA_py2*DATA_py2),DATA_unrot_pz2);
           // Find Model energy2
           double DATA_denom2 = 1+2*sin(DATA_unrot_theta2/2)*sin(DATA_unrot_theta2/2)*(1056/0.5109989);
           double DATA_model2 = 1.056/DATA_denom2;
...
// ChiSq Cuts
	...
	//  if(sin(DATA_unrot_theta1/2)*sin(DATA_unrot_theta2/2)>=0.00016 && sin(DATA_unrot_theta1/2)*sin(DATA_unrot_theta2/2)<=0.00045 && DATA_unrot_theta1+DATA_unrot_theta2<=0.09)
	 ...
	 // if(true)
          if(DATA_TrackE1<=0.85 && DATA_TrackE2<=0.85)
            {
	...
	//  if((abs(DATA_TrackE1-DATA_model1)<=0.2 && abs(DATA_TrackE2-DATA_model2)<= 0.2))
	  if(DATA_TrackE1+DATA_TrackE2<=1.2 && DATA_TrackE1+DATA_TrackE2>=0.9)
	//  if(DATA_TrackE1+DATA_TrackE2<=1.2 && DATA_TrackE1+DATA_TrackE2>=0.9 && DATA_E1+DATA_E2<=1.2 && DATA_E1+DATA_E2>=0.9)
            {
...
double PURE_Lumin = 74*(2e6)*(625)*(4.062e-4)*(6.306e-2)*num_PURE_files; // Total luminosity for pure Mollers (2M bunches) (1/barns)
...
tr3->Add("/cache/mss/hallb/hps/production/postTriSummitFixes/dst/moller/1pt05/molv3_5mrad_HPS-EngRun2015-Nominal-v5-0-fieldmap_3.11-20161202_singles0_*.root");
  ...
  TH2D *PURE_CUT_moller_thetaE = new TH2D("PURE_CUT_moller_thetaE","Moller Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);
  TH1D *PURE_CUT_moller_E = new TH1D("PURE_CUT_moller_E", ";Energy (GeV)", 200, 0.,2);
  TH1D *PURE_ClusterE = new TH1D("PURE_ClusterE","Cluster Energy;Energy (GeV)", 200, 0., 1);
  TH1D *PURE_ClusterE1 = new TH1D("PURE_ClusterE1","Cluster Energy;Energy (GeV)", 200, 0., 1);
  TH1D *PURE_ClusterE2 = new TH1D("PURE_ClusterE2","Cluster Energy;Energy (GeV)", 200, 0., 1);
  TH1D *PURE_TrackE = new TH1D("PURE_TrackE","Track Energy;Energy (GeV)", 200, 0.,1);
//  TH2D *DATA_ClusterEE = new TH2D("DATA_ClusterEE","Cluster E1 vs. E2;Electron E (GeV);Positron E (GeV)",200,0.0,2.5,200,0.0,2.5);
  TH2D *PURE_ClusterEE = new TH2D("PURE_ClusterEE","Cluster E1 vs. E2;E1 (GeV);E2 (GeV)",200,0.0,2,200,0.0,2);
  TH1D *PURE_CUT_moller_Theta = new TH1D("PURE_CUT_moller_Theta", ";Theta (rad)", 200, 0.0, 0.08);
  TH1D *PURE_TRACK_ESum = new TH1D("PURE_TRACK_ESum","V0 Track Energy Sum;Energy (GeV)", 200, 0,2);
  TH1D *PURE_CLUSTER_ESum = new TH1D("PURE_CLUSTER_ESum","V0 Cluster Energy Sum;Energy (GeV)", 200, 0.,2);
  TH2D *PURE_CUT_unrot_moller_thetaE = new TH2D("PURE_CUT_unrot_moller_thetaE","'Unrotated' Moller Theta vs. E;Energy (GeV);Theta (rad)",200,0.0,2,200,0.0,0.13);
  TH1D *PURE_CUT_ETTest = new TH1D("PURE_CUT_ETTest","E - Ebeam/(1+(2Ebeam/m)sin^2(theta/2);Energy (GeV)",200,-0.4,0.4);
//  TH2D *DATA_TrackEE = new TH2D("DATA_TrackEE","Track E1 vs. E2;Electron E (GeV);Positron E (GeV)",200,0.0,1.056,200,0.0,1.056);
  TH2D *PURE_TrackEE = new TH2D("PURE_TrackEE","Track E1 vs. E2;E1 (GeV);E2 (GeV)",200,0.0,2.5,200,0.0,2);
  TH2D *PURE_CUT_MollerTT = new TH2D("PURE_CUT_MollerTT","Theta1 vs. Theta2;Theta (rad);Theta (rad)",200,0.0,0.13,200,0.0,0.13);
  TH1D *PURE_CUT_SinSinTest = new TH1D("PURE_CUT_SinSinTest","Prox. to Model (m/2Ebeam);Sin(T1/2)Sin(T2/2)", 200, 0,0.0008);
  TH2D *PURE_CUT_moller_EP = new TH2D("PURE_CUT_moller_EP","Moller Track E vs. Cluster E;Energy (GeV);Momentum (GeV/c)",200,0.0,1.056,200,0.0,1.056);
  TH1D *PURE_Mass = new TH1D("PURE_Mass","V0 Candidate Mass;Mass(GeV)", 200, 0.0,0.06);
  ...
  TH1D *PURE_moller_ESum = new TH1D("PURE_moller_ESum","Track Energy Sum;Energy (GeV)", 200, 0.0, 2);
  ...
  TH1D *PURE_seed_E = new TH1D("seed_E","Seed Energy;Energy (GeV)", 200, 0., 1);
...
// ECAL
  TH1D *PURE_FIDUCIAL_Moller_E = new TH1D("PURE_FIDUCIAL_Moller_E","Cluster E (Fiducial);Energy (GeV)", 200, 0., 1);
  TH1D *PURE_EDGE_Moller_E = new TH1D("PURE_EDGE_Moller_E","Cluster E (Edge);Energy (GeV)", 200, 0., 1);
  TH1D *PURE_EDGE_TRACK_E = new TH1D("PURE_EDGE_Moller_E","Cluster E (Edge);Energy (GeV)", 200, 0., 1);

  PURE_EDGE_TRACK_E->SetLineColor(kGreen);

  TH2D *PURE_EP = new TH2D("PURE_EP","Moller Track E vs. Cluster E;Energy (GeV);Momentum (GeV/c)",200,0.0,1.056,200,0.0,1.056);
...
//  TH2D *DATA_ECal_hits=new TH2D("DATA_CUT_ECal_hits","",49,-24.5,24.5, 13,-6.5,6.5);
  ...
  TH1D *PURE_CUT_EPRatio = new TH1D("PURE_CUT_EPRatio","E/P Ratio;ClusterE/TrackP", 200, 0,2);
  TH1D *PURE_FIDUCIAL_Moller_EPRatio = new TH1D("PURE_CUT_FIDUCIAL_Moller_EPRatio","E/P Ratio (Fiducial);ClusterE/TrackP", 200, 0,2);
  TH1D *PURE_EDGE_Moller_EPRatio = new TH1D("PURE_CUT_EDGE_Moller_EPRatio","E/P Ratio (Edge);ClusterE/TrackP", 200, 0,2);
  ...
  TH1D *PURE_EDGE_TRACK_Moller_E = new TH1D("PURE_EDGE_TRACK_Moller_E","Track E (Edge);Energy (GeV)", 200, 0., 1);
  TH1D *PURE_FIDUCIAL_TRACK_Moller_E = new TH1D("PURE_FIDUCIAL_TRACK_Moller_E","Track E (Fiducial);Energy (GeV)", 200, 0., 1);
...
//          TRefArray *DATA_SVT_hits2 = DATA_moller_track2->getSvtHits();
	...
	// FIRST MOLLER
	  PURE_moller_clust1 = (EcalCluster*)PURE_moller_clusters1->At(0);
          ...
          // Find Model energy
          double PURE_denom1 = 1+2*sin(PURE_unrot_theta1/2)*sin(PURE_unrot_theta1/2)*(1056/0.5109989);
          double PURE_model1 = 1.056/PURE_denom1;
        ...
        // SECOND MOLLER
          ...
          vector<double>  PURE_mom2 = PURE_moller2->getMomentum(); double PURE_px2 = PURE_mom2[0]; double PURE_py2 = PURE_mom2[1]; double PURE_pz2 = PURE_mom2[2];
           ...
           // Find Model energy2
           double PURE_denom2 = 1+2*sin(PURE_unrot_theta2/2)*sin(PURE_unrot_theta2/2)*(1056/0.5109989);
           double PURE_model2 = 1.056/PURE_denom2;
...
// Momar Cuts //  if(DATA_TrackE1>=0.05 && DATA_TrackE2>=0.05 && DATA_TrackE1<=0.85 && DATA_TrackE2<=0.85 && abs(DATA_time1-DATA_time2)<=1.6 && DATA_tanLambda1*DATA_tanLambda2 < 0)
	    ...
	    PURE_CUT_unrot_moller_thetaE->Fill(PURE_TrackE1,PURE_unrot_theta1); PURE_CUT_unrot_moller_thetaE->Fill(PURE_TrackE2,PURE_unrot_theta2);
      ...
      for(int k=1;k<=200000;k++)
        {
          ...
          // Theta-Energy Model
          modelT = k*0.13/200000;
          modelDenom = 1+2*sin(modelT/2)*sin(modelT/2)*(1056/0.5109989);
          moller_thetaE->Fill(1.056/modelDenom,modelT);
          unrot_moller_thetaE->Fill(1.056/modelDenom,modelT);
          CUT_moller_thetaE->Fill(1.056/modelDenom,modelT);
          CUT_unrot_V0_thetaE->Fill(1.056/modelDenom,modelT);
          DATA_CUT_unrot_moller_thetaE->Fill(1.056/modelDenom,modelT);

          electron_thetaE->Fill(1.056/modelDenom,modelT);

          // Theta-Theta Model
          modelAngleCorr = 2*asin(0.5109989/2/1056/sin(modelT/2));
          MollerTT->Fill(modelT,modelAngleCorr);
          CUT_V0TT->Fill(modelT,modelAngleCorr);
          DATA_CUT_MollerTT->Fill(modelT,modelAngleCorr);

          // Energy-Energy Model
          ModelE = k*1.056/200000;
          MollerEE->Fill(ModelE,1.056-ModelE);
          TRACK_V0EE->Fill(ModelE,1.056-ModelE);
          CLUSTER_V0EE->Fill(ModelE,1.056-ModelE);
          DATA_ClusterEE->Fill(ModelE,1.056-ModelE);
          DATA_TrackEE->Fill(ModelE,1.056-ModelE);
...
DATA_Mass->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_massSingles1->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_massGBL->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_mass1->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_mass2->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_mass3->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_TrackE->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_ClusterE->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_ClusterE1->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_ClusterE2->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_EDGE_TRACK_Moller_E->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_FIDUCIAL_TRACK_Moller_E->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_EDGE_Moller_E->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_FIDUCIAL_Moller_E->Scale(DATA_Prescale*1000/DATA_Lumin/74/2); // one of 471 files used
...
DATA_CUT_moller_Theta->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_TRACK_ESum->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CLUSTER_ESum->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_SinSinTest->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_ETTest->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_highET->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_lowET->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_MollerXVTX->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_MollerYVTX->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_MollerZVTX->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_CUT_V0_coincidence->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_coplanarity->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_phiDiff->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_hitxDiff->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_hityDiff->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_TrackChi2->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_vtxChi2->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_px->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_py->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_pz->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
...
DATA_eventsTrackE->Scale(DATA_Prescale*1000/DATA_Lumin/74/2);
