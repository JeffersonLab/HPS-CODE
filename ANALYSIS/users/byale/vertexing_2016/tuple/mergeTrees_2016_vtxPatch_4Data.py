...
vertCut = "isPair1&&eleHasL1&&posHasL1&&max(abs(eleClT-eleTrkT)-10000,abs(posClT-posTrkT)-10000)<4&&abs(eleClT-posClT)<2&&eleSlope*posSlope<0<0&&chisqFitBSC<10&&chisqFitBSC-chisqFitUnc<5&&max(eleTrkChisq,posTrkChisq)<30&&min(eleMinPositiveIso+0.5*(eleTrkZ0+{2}*elePY/eleP)*sign(elePY),posMinPositiveIso+0.5*(posTrkZ0+{2}*posPY/posP)*sign(posPY))>0&&abs(eleP-posP)/(eleP+posP)<0.4&&posTrkD0+{2}*posPX/posP<1.5&&eleP<{0}*0.75&&uncP<{0}*1.15"
