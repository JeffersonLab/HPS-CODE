...
#masses = [0.050, 0.075, 0.100, 0.150, 0.200, 0.250]
...
masses = [0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080, 0.085, 0.090, 0.095, 0.100, 0.125, 0.150, 0.175, 0.200, 0.225, 0.250]
#masses = [0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080, 0.085, 0.090, 0.095, 0.100, 0.125, 0.150, 0.175]
...
for filenum in range(0,len(remainder)-1):
    ...
    gammaArr.append((-1.0/prodz.GetFunction("expo").GetParameter(1))/(2.3/masses[filenum]))
    ...
    effAtTarget = effAll.GetFunction("exppol4").Eval(0.5)
...
graph.GetXaxis().SetRangeUser(0.040,0.27)
graph.GetYaxis().SetRangeUser(0.0010,0.0050)
c.Print(remainder[0]+".pdf","Title:test")

molmassArr=array.array('d')
molmresArr=array.array('d')
#mine
#molmassArr.append(0.04895)
#molmresArr.append(0.001601)
#Sebouhs FWHM
molmassArr.append(0.0487)
molmresArr.append(0.00175)
#Sebouhs Full Fit
molmassArr.append(0.0487)
molmresArr.append(0.00184)
molgraph=TGraph(len(molmassArr),molmassArr,molmresArr)
molgraph.SetMarkerColor(4)
molgraph.Draw("*")

#Data Mollers
molmassDataArr=array.array('d')
molmresDataArr=array.array('d')
molmassDataArr.append(0.0493)
molmresDataArr.append(0.00258)
molmassDataArr.append(0.0493)
molmresDataArr.append(0.00247)
molgraphData=TGraph(len(molmassDataArr),molmassDataArr,molmresDataArr)
molgraphData.SetMarkerColor(2)
molgraphData.Draw("*")
