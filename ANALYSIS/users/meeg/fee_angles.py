...
hnew.GetYaxis().SetTitle("Track Y at closest approach [mm]")
hnew_1 = gDirectory.Get("hnew_1")
c.cd(2)
hnew_1.Draw()
hnew_1.GetXaxis().SetTitle("Track slope")
hnew_1.GetYaxis().SetTitle("Track Y at closest approach [mm]")
...
hnew = gDirectory.Get("hnew")
hnew.SetTitle("Elastic electrons, top")
hnew.GetXaxis().SetTitle("theta_x relative to beam axis [rad]")
hnew.GetYaxis().SetTitle("p [GeV]")
hnew.FitSlicesY()
hnew_1 = gDirectory.Get("hnew_1")
c.cd(2)
hnew_1.Draw()
hnew_1.GetXaxis().SetTitle("theta_x relative to beam axis [rad]")
hnew_1.GetYaxis().SetTitle("p [GeV]")
hnew_1.Fit("pol1","","",-0.06,0.01)
