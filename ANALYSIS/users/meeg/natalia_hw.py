...
dataEvents.Draw("tarP>>data1d(100,0,1.5)","abs(elePX/eleP)<0.005&&abs(posPX/posP)<0.005&&abs(abs(elePY/eleP)-0.04)<0.005&&abs(abs(posPY/posP)-0.04)<0.005&&elePY*posPY<0","colz")
