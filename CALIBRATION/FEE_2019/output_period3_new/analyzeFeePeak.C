...
const double COSMIC_FACTOR = 0.866;
	  ...
	  if (!ishole(jx,jy)){
		...
		if (ITER==1){	  
		  ...
		  case 107:
		    ...
		    break;
		  case 362:
		    MPV[jx][jy]=4.371/EBEAM;
		    break;
		  case 377:
		    MPV[jx][jy]=4.541/EBEAM;
		    break;
		  case 315:
		    MPV[jx][jy]=4.431/EBEAM;
		    break;
		  case 272:
		    MPV[jx][jy]=4.235/EBEAM;
		    break;
		  case 164:
		    MPV[jx][jy]=4.592/EBEAM;
		    break;
		  default:
		    break;	    
		  }
