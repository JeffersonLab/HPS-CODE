...
//=========  (Wed Jul 22 18:06:53 2020) by ROOT version 6.18/04
   TCanvas *scr = new TCanvas("scr", "xxxx",0,0,1200,800);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   scr->Range(-17.5625,-0.1875,8.5625,1.6875);
   scr->SetFillColor(0);
   scr->SetBorderMode(0);
   scr->SetBorderSize(2);
   ...
   0.8545779,
   0.8859168};
   graph = new TGraph(16,grp1_fx2,grp1_fy2);
   graph->SetName("grp1");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp12 = new TH1F("Graph_grp12","",100,-13.6,5.6);
   Graph_grp12->SetMinimum(0.8200711);
   Graph_grp12->SetMaximum(0.9308552);
   ...
   0.8607901,
   0.8573194};
   graph = new TGraph(18,grp2_fx3,grp2_fy3);
   graph->SetName("grp2");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp23 = new TH1F("Graph_grp23","",100,-15.8,5.8);
   Graph_grp23->SetMinimum(0.8294404);
   Graph_grp23->SetMaximum(0.9261488);
   ...
   TH1F *Graph_grp34 = new TH1F("Graph_grp34","",100,-15.9,6.9);
   Graph_grp34->SetMinimum(0.8090493);
   Graph_grp34->SetMaximum(1.206808);
   ...
   0.8629828,
   0.9195601};
   graph = new TGraph(15,grp6_fx7,grp6_fy7);
   graph->SetName("grp6");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp67 = new TH1F("Graph_grp67","",100,-14.8,6.8);
   Graph_grp67->SetMinimum(0.8322032);
   Graph_grp67->SetMaximum(0.9720874);
   ...
   0.8590211,
   0.8705508};
   graph = new TGraph(17,grp7_fx8,grp7_fy8);
   graph->SetName("grp7");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp78 = new TH1F("Graph_grp78","",100,-14.8,6.8);
   Graph_grp78->SetMinimum(0.830331);
   Graph_grp78->SetMaximum(0.9081369);
   ...
   0.8481752,
   0.8450893};
   graph = new TGraph(17,grp8_fx9,grp8_fy9);
   graph->SetName("grp8");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp89 = new TH1F("Graph_grp89","",100,-14.7,5.7);
   Graph_grp89->SetMinimum(0.8111399);
   Graph_grp89->SetMaximum(0.8943133);
