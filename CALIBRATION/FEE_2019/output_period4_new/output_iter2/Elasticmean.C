...
//=========  (Wed Jul 22 11:43:30 2020) by ROOT version 6.18/04
   TCanvas *scr = new TCanvas("scr", "xxxx",0,0,1200,800);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   scr->Range(-15,-0.1875,7,1.6875);
   scr->SetFillColor(0);
   scr->SetBorderMode(0);
   scr->SetBorderSize(2);
   ...
   Graph_grp12->SetMinimum(0.9599508);
   Graph_grp12->SetMaximum(1.004588);
   ...
   Graph_grp23->SetMinimum(0.9731653);
   Graph_grp23->SetMaximum(1.002834);
   ...
   0.9766369,
   0.971788};
   graph = new TGraph(16,grp3_fx4,grp3_fy4);
   graph->SetName("grp3");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp34 = new TH1F("Graph_grp34","",100,-13.6,5.6);
   Graph_grp34->SetMinimum(0.9628424);
   Graph_grp34->SetMaximum(1.070191);
   ...
   Graph_grp67->SetMinimum(0.9665819);
   Graph_grp67->SetMaximum(1.009108);
   ...
   Graph_grp78->SetMinimum(0.9732871);
   Graph_grp78->SetMaximum(1.002269);
   ...
   0.9774233,
   0.8929319};
   graph = new TGraph(14,grp8_fx9,grp8_fy9);
   graph->SetName("grp8");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_grp89 = new TH1F("Graph_grp89","",100,-12.4,4.4);
   Graph_grp89->SetMinimum(0.8830457);
   Graph_grp89->SetMaximum(1.00168);
