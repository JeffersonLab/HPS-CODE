...
//=========  (Wed Jul 22 10:26:05 2020) by ROOT version 6.18/04
   ...
   Graph_grp12->SetMinimum(0.8524385);
   Graph_grp12->SetMaximum(0.9671062);
   ...
   Graph_grp23->SetMinimum(0.8574599);
   Graph_grp23->SetMaximum(0.9623015);
   ...
   Graph_grp34->SetMinimum(0.8432656);
   Graph_grp34->SetMaximum(1.244079);
   ...
   Graph_grp67->SetMinimum(0.8686728);
   Graph_grp67->SetMaximum(1.001847);
   ...
   Graph_grp78->SetMinimum(0.8639151);
   Graph_grp78->SetMaximum(0.9460533);
   ...
   Graph_grp89->SetMinimum(0.843609);
   Graph_grp89->SetMaximum(0.9237289);
