...
//=========  (Sun Jul 26 21:09:34 2020) by ROOT version 6.18/04
   ...
   Graph_grp12->SetMinimum(0.9824768);
   Graph_grp12->SetMaximum(1.007178);
   ...
   Graph_grp23->SetMinimum(0.9868751);
   Graph_grp23->SetMaximum(1.006474);
   ...
   Graph_grp34->SetMinimum(0.9646373);
   Graph_grp34->SetMaximum(1.073388);
   ...
   Graph_grp67->SetMinimum(0.9679965);
   Graph_grp67->SetMaximum(1.014091);
   ...
   Graph_grp78->SetMinimum(0.9859141);
   Graph_grp78->SetMaximum(1.005711);
   ...
   Graph_grp89->SetMinimum(0.9795933);
   Graph_grp89->SetMaximum(0.9991183);
