...
//=========  (Mon Jul 27 19:21:12 2020) by ROOT version 6.18/04
   ...
   Graph_grp12->SetMinimum(0.9972041);
   Graph_grp12->SetMaximum(1.002592);
   ...
   Graph_grp23->SetMinimum(0.993689);
   Graph_grp23->SetMaximum(1.002828);
   ...
   Graph_grp34->SetMinimum(0.9893641);
   Graph_grp34->SetMaximum(1.019841);
   ...
   Graph_grp67->SetMinimum(0.9933449);
   Graph_grp67->SetMaximum(1.002507);
   ...
   Graph_grp78->SetMinimum(0.9818548);
   Graph_grp78->SetMaximum(1.004408);
   ...
   Graph_grp89->SetMinimum(0.9977412);
   Graph_grp89->SetMaximum(1.001448);
