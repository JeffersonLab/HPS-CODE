...
const double COSMIC_FACTOR = 0.867;
  ...
  for (int jy=0; jy<NY; jy++)
      ...
      for (int jx=0; jx<NX; jx++)
	{
	  if (!ishole(jx,jy)){
		...
		if ((sigma[jx][jy]>.2)||(sigma[jx][jy]<0)) {		 
		...
		if (ITER==1){	  
		  ...
		  case 107:
		    ...
		    break;
		  case 159: //(-3,2)
		    MPV[jx][jy]=4.24/EBEAM;
		    break;
		  case 162: //(1,2)
		    MPV[jx][jy]=4.6/EBEAM;
		    break;
		  case 362: //(-12,-4)
		    MPV[jx][jy]=4.399/EBEAM;
		    break;
		  case 316: //(-12,-3)
		    MPV[jx][jy]=4.428/EBEAM;
		    break;
		  case 284: //(3,-2)
		    MPV[jx][jy]=4.582/EBEAM;
		    break;
		  case 285: //(4,-2)
		    MPV[jx][jy]=4.352/EBEAM;
		    break;
		  default:
		    break;
		  ...
		  default:
		    ...
		    case 107:
		      ...
		      break;
		    case 316:
		      MPV[jx][jy]=4.033/EBEAM;
		      break;
		    case 283:
		      MPV[jx][jy]=4.013/EBEAM;
		      break;
		    case 72:
		      MPV[jx][jy]=-1;
		      break;
