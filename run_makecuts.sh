...
#~/bin/tuple/applyCut.py golden_vertcuts.root /nfs/slac/g/hps3/users/meeg/goldentuple/golden_vert.root -t vertexing -bv
...
~/bin/tuple/applyCut.py tritrig_pass6_vertcuts.root /nfs/slac/g/hps3/users/meeg/tritrigtuple/tritrig_pass6_vert.root -t vertexing -bv
