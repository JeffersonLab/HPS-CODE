...
c.cd(1)
gPad.SetLogy()
events.Draw("uncM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
...
c.cd(2)
gPad.SetLogy()
events.Draw("vzcM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(3)
gPad.SetLogy()
events.Draw("uncM*{0}/uncP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(4)
gPad.SetLogy()
events.Draw("vzcM*{0}/vzcP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(1)
gPad.SetLogy()
events.Draw("uncM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"abs(topTrkT-botTrkT)<3&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(2)
gPad.SetLogy()
events.Draw("vzcM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"abs(topTrkT-botTrkT)<3&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(3)
gPad.SetLogy()
events.Draw("uncM*{0}/uncP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"abs(topTrkT-botTrkT)<3&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(4)
gPad.SetLogy()
events.Draw("vzcM*{0}/vzcP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"abs(topTrkT-botTrkT)<3&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(1)
gPad.SetLogy()
events.Draw("uncM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005&&(topHasL1&&botHasL1)","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(2)
gPad.SetLogy()
events.Draw("vzcM>>hnew(100,{0},{1})".format(0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005&&(topHasL1&&botHasL1)","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(3)
gPad.SetLogy()
events.Draw("uncM*{0}/uncP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005&&(topHasL1&&botHasL1)","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
...
c.cd(4)
gPad.SetLogy()
events.Draw("vzcM*{0}/vzcP>>hnew(100,{1},{2})".format(ebeam,0.5*molmass,2*molmass),"max(topMatchChisq,botMatchChisq)<5&&abs(topClT-botClT)<2&&abs(uncPX/uncP)<0.005&&abs(uncPY/uncP)<0.005&&(topHasL1&&botHasL1)","colz")
hnew = gDirectory.Get("hnew")
hnew.Fit("gaus","","",0.9*molmass,1.1*molmass)
gaus = hnew.GetFunction("gaus")
cb.SetParameters(gaus.GetParameter(0),gaus.GetParameter(1),gaus.GetParameter(2),-1.5,2.5)
