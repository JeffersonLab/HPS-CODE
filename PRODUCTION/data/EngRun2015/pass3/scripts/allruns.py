...
PARS={
    'PASS':'pass3',
    'DETECTOR':'HPS-EngRun2015-Nominal-v3-1-fieldmap',
    ...
    'RELEASE':'20151010092742126',
    'JAR':'hps-distribution-3.4.1-20151010.092742-126-bin.jar',
...
def allruns(runs):
    ...
    if len(runs)==2: runs=range(int(runs[0]),int(runs[1])+1)
